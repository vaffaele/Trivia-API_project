...
GET \questions?page=<page_number> Fetches a paginated dictionary of all questions
...
POST /quizzes Fetches one random question within a specified category. Previously are not allowed. 
