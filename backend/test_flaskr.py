...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_422__delete_question(self):
        res = self.client().delete(f'/questions/123131')
        data = json.loads(res.data)
    ...
    def test_422_play_quiz(self):
        new_quiz_round = {'previous_questions': [],'quiz_category': {'type': '', 'id': 5}}
